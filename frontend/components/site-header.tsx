      ...
      <div className=" header-top flex items-center justify-between px-8 pb-1 gap-4">
        ...
        <div className="min-w-[120px]">
          <Link href="/" className="flex flex-row gap-1">
            <Image
              src="/images/Qi.png"
              className="w-8 h-6 bg-cover"
              width={16}
              height={15}
              alt="Qi"
            />
            <Image
              src="/images/flearn.png"
              className="w-20 h-6 bg-cover"
              width={50}
              height={28}
              alt="flearn"
            />
        ...
        {/* 네비게이션 */}
        <nav className="hidden lg:flex  main-nav  gap-6 text-base font-bold text-gray-700">
        ...
        {session && (
          <Link href="/instructor">
            <Button
              variant="outline"
              className="font-semibold shadow-sm hover:ring-1 hover:ring-green-400 hover:shadow-md  hover:!bg-green-50 transition-colors"
            >
              나의 채널
            </Button>
          </Link>
        ...
        {session && (
          <Popover>
            <PopoverTrigger asChild>
              <button className="flex p-2 rounded-full shadow-sm hover:ring-1 hover:ring-green-400 hover:shadow-md  hover:!bg-green-50 transition-colors cursor-pointer">
        ...
        {session ? (
          <Popover>
            <PopoverTrigger asChild>
              <div className="ml-1 ring-neutral-200 ring-1 hover:ring-green-500 rounded-full cursor-pointer ">
                <Avatar>
