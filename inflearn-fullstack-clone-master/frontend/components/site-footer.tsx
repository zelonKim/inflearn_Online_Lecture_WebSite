    ...
    <footer className="bg-gray-800 text-white mt-16 ">
      <div className="max-w-auto sm:px-12 md:px-16 lg:px-20 xl:px-24 py-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-white">zinflearn</span>
              </div>
            </Link>
        ...
        <div className="space-y-2 text-sm text-gray-300">
          <div>
            (주)진프랩 | 대표자: 김성진 | 사업자번호: 123-45-6789{" "}
            <Link
              href="#"
          ...
          <div>
            ...
            이메일:{" "}
            <Link
              href="mailto:ksz1860@zinflearn.com"
              className="underline hover:text-white transition-colors"
            >
              ksz1860@zinflearn.com
            </Link>
          </div>
          <div>
            전화번호:{" "}
